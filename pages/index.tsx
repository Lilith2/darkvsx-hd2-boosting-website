...
import { DynamicServiceFilter } from "@/components/DynamicServiceFilter";
import {
  Star,
  Shield,
  Target,
      ...
      <SEOHead
        ...
        structuredData={{
          ...
          potentialAction: {
            "@type": "SearchAction",
            target:
              "https://helldivers2boost.com/search?q={search_term_string}",
      ...
      <div className="bg-gradient-to-br from-background via-background to-background/80">
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            {/* Features Grid */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-12 sm:mt-16 lg:mt-20 px-4 sm:px-0">
            ...
            {activeServices.length === 0 ? (
              <div className="text-center py-20">
                ...
                <p className="text-muted-foreground max-w-md mx-auto mb-8 text-lg">
                  We're currently setting up our amazing boosting services.
                  Check back soon for incredible Helldivers 2 options!
                </p>
                <Button
                  variant="outline"
                  size="lg"
