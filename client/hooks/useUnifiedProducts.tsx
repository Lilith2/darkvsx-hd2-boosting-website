...
interface UnifiedProductsContextType {
  ...
  // Bulk Operations
  bulkUpdateProducts: (
    updates: Array<{ id: string; data: Partial<UnifiedProduct> }>,
  ) => Promise<void>;
...
const UnifiedProductsContext = createContext<
  UnifiedProductsContextType | undefined
>(undefined);
...
export const useUnifiedProducts = () => {
  ...
  if (context === undefined) {
    throw new Error(
      "useUnifiedProducts must be used within a UnifiedProductsProvider",
    );
  }
  return context;
};
...
export const UnifiedProductsProvider = ({
  children,
}: UnifiedProductsProviderProps) => {
  ...
  const createProduct = async (
    productData: Partial<UnifiedProduct>,
  ): Promise<string> => {
    try {
      setLoading(true);
      setError(null);
