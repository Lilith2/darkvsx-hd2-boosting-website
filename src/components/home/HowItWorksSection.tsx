          ...
          {[
            {
              ...
              description:
                "Select the boosting service that fits your needs from our comprehensive catalog.",
            },
            {
              step: "02",
              title: "Place Order",
              description:
                "Complete your order with our secure checkout process and provide any special requirements.",
            },
            {
              step: "03",
              title: "Get Matched",
              description:
                "We assign a professional booster who specializes in your selected service type.",
            },
            {
              step: "04",
              title: "Track Progress",
              description:
                "Monitor your order in real-time and communicate directly with your booster.",
            },
          ].map((step, index) => (
