...
export function exportToCSV(
  ...
  const selectedFieldObjects = fields.filter((field) =>
    options.selectedFields.includes(field.key),
  );
  ...
  if (options.includeHeaders) {
    const headers = selectedFieldObjects
...
export function getOrderExportFields(): ExportField[] {
  return [
    ...
    { key: "customer_email", label: "Customer Email", default: true },
    {
      ...
      label: "Status",
      default: true,
      transform: fieldTransforms.status,
    },
    {
      key: "total_amount",
      label: "Total Amount",
      default: true,
      transform: fieldTransforms.currency,
    },
    {
      key: "payment_status",
    ...
    },
    {
      ...
      label: "Created Date",
      default: true,
      transform: fieldTransforms.date,
    },
    {
      key: "updated_at",
      label: "Updated Date",
    ...
    { key: "orderType", label: "Order Type", default: true },
    {
      ...
      label: "Services",
      default: false,
      transform: fieldTransforms.json,
    },
    {
      key: "items",
      label: "Items",
    ...
    },
    {
      ...
      label: "Notes",
      default: false,
      transform: fieldTransforms.truncate(200),
    },
  ];
}
